 ...
 * @since 1.1.0
 */
public class WebxmlMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = WebxmlMetadata.class.getName();
    ...
    public WebxmlMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
